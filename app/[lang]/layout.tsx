...
const META: Record<Locale, { title: string; description: string }> = {
  en: {
    ...
    description:
      'Senior software engineer, 8+ years across military aviation, telecom, and consumer platforms. Interactive 3D cockpit portfolio with streaming AI assistant. EN/IT.',
  },
  it: {
    title: 'Matteo Dante · Cockpit Portfolio',
    description:
      'Senior software engineer, 8+ anni tra aviazione militare, telco e piattaforme consumer. Portfolio 3D cockpit interattivo con assistente AI in streaming. EN/IT.',
  },
}
